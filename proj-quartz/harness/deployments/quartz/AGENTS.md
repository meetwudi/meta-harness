...
- The relevant approval records in [cloud-resource-approvals/](cloud-resource-approvals/)
...
resource, verify that the corresponding approval record exists and cites the
specific approval time.

Cloud resource approval records must include enough provider pointers to manage
the resource later. For Google Cloud resources, keep the Google Cloud project,
