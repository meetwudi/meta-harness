...
//#region src/lib/persistence.ts
	...
	function getOrCreateTelemetryDistinctId() {
		...
		try {
			...
			var _inMemoryFallbackId;
			return (_inMemoryFallbackId = inMemoryFallbackId) !== null && _inMemoryFallbackId !== void 0 ? _inMemoryFallbackId : inMemoryFallbackId = generateUuidV4();
		}
	}
      ...
      <span class="announcement-preview__arrow"></span>
		...
		async fetchAnnouncement() {
			try {
				...
				const ctaLabel = typeof (data === null || data === void 0 ? void 0 : data.cta_label) === "string" ? data.cta_label : null;
				...
				if (this.hasUnseenAnnouncement && !this.viewedBannerTimestamps.has(timestamp)) {
					...
					this.pendingBannerViewed = {
						banner_id: timestamp,
						cta_label: ctaLabel !== null && ctaLabel !== void 0 ? ctaLabel : void 0
					};
					this.flushPendingBannerViewed();
				}
				this.requestUpdate();
