...
4. Resolve requested or relevant Libraries through storage discovery and Librarian tools.
...
If a `library://` reference cannot be resolved, report the missing Library name and the storage locations or Librarian results checked.
